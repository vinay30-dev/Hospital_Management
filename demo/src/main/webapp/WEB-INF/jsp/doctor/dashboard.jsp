  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <head>
      ...
      <style>
        ...
        .portal-bg-grid {
          position: fixed;
          inset: 0;
          background-image: linear-gradient(rgba(14, 232, 196, .04) 1px, transparent 1px), linear-gradient(90deg, rgba(14, 232, 196, .04) 1px, transparent 1px);
        ...
        .portal-nav {
          position: relative;
          z-index: 10;
          background: rgba(11, 22, 40, .82) !important;
          backdrop-filter: blur(14px);
          border-bottom: 1px solid rgba(14, 232, 196, .15) !important;
        }
        ...
        .portal-stat {
          ...
          border: 1px solid rgba(14, 232, 196, .12);
          border-radius: 12px;
          padding: .85rem 1rem;
        }
        ...
        .panel-card {
          ...
          border: 1px solid rgba(14, 232, 196, .12) !important;
          border-radius: 14px;
          backdrop-filter: blur(14px);
        ...
        .portal-page .form-select {
          background: rgba(11, 22, 40, .7) !important;
          border: 1px solid rgba(136, 146, 176, .25) !important;
          color: #ccd6f6 !important;
        }

        .portal-page .form-control:focus,
        .portal-page .form-select:focus {
          border-color: #0ee8c4 !important;
          box-shadow: 0 0 0 3px rgba(14, 232, 196, .12) !important;
        }

        .portal-page .btn-primary {
          background: linear-gradient(135deg, #0ee8c4, #0acfb1);
          border: none;
          color: #0b1628;
          font-weight: 600;
          box-shadow: 0 8px 22px rgba(14, 232, 196, .35);
        }

        .portal-page .btn-outline-light {
          border-color: rgba(204, 214, 246, .35);
          color: #ccd6f6;
        }
    ...
    <body class="app-bg portal-body portal-page">
            ...
            <div class="dropdown me-2">
              <button class="btn btn-outline-light btn-sm position-relative dropdown-toggle" type="button"
                ...
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"
                  id="notifBadge" style="display:none;">0</span>
              </button>
              <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notifDropdown" id="notifList"
                style="min-width: 250px; background: rgba(11,22,40,.9); border: 1px solid rgba(14,232,196,.15);">
                <li><a class="dropdown-item text-white-50" href="#">No new notifications</a></li>
              </ul>
            </div>
            <span class="text-white-50 small d-none d-md-inline">Signed in as <span
                class="text-white">${sessionScope.displayName}</span></span>
            <a class="btn btn-outline-light btn-sm"
              href="${pageContext.request.contextPath}/doctor/analytics">Analytics</a>
              ...
              <div class="card-body">
                ...
                <div class="vstack gap-3">
                  ...
                  <div class="mt-2">
                    ...
                    <ul id="doctorSlotsList" class="list-group list-group-flush bg-transparent small overflow-auto"
      ...
      <div class="modal fade" id="docsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content"
            style="background: rgba(11,22,40,.95); border: 1px solid rgba(14,232,196,.25); color: #ccd6f6;">
      ...
      <footer class="portal-footer">
        <p class="mb-0">${sessionScope.displayName} · Physician · <a href="${initParam.nodeApiBase}/health"
            target="_blank" rel="noopener">API health</a></p>
      </footer>
